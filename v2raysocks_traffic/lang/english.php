...
$_LANG = [
    ...
    'pagination_size_description' => 'Default number of records to load per page for data queries',
    'custom_pagination_size' => 'Custom Pagination Size',
    'custom_pagination_size_description' => 'Custom pagination size (used when "Custom" is selected above). Must be between 100 and 1,000,000.',
    'module_refresh_interval' => 'Module Refresh Interval (optional)',
    'module_refresh_interval_description' => 'Optional automatic refresh interval for module pages',
    'custom' => 'Custom',
    'disabled' => 'Disabled',
