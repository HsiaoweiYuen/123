...
$_LANG = [
    ...
    'pagination_size_description' => '資料查詢每頁載入的預設記錄數',
    'custom_pagination_size' => '自訂分頁大小',
    'custom_pagination_size_description' => '自訂分頁大小 (當選擇「自訂」時使用)。必須在100到1,000,000之間。',
    'module_refresh_interval' => '模組重新整理間隔 (可選)',
    'module_refresh_interval_description' => '模組頁面的可選自動重新整理間隔',
    'custom' => '自訂',
    'disabled' => '停用',
