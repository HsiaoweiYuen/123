    ...
    return [
        ...
        'fields' => [
            ...
            'default_page_size' => [
                ...
                'Default' => '1000',
                'Description' => isset($lang['default_page_size_description']) ? $lang['default_page_size_description'] : 'Default number of records to display per page in module pages',
            ],
        ]
    ];
}
        ...
        case 'get_node_traffic_rankings':
            try {
                ...
                if ($usePagination) {
                    ...
                    $result = v2raysocks_traffic_getNodeTrafficRankingsPaginated($sortBy, $timeRange, $startTimestamp, $endTimestamp, $cursor, $limit, $direction);
                    $result['status'] = 'success';
                    $result['pagination'] = true;
        ...
        case 'get_user_traffic_rankings':
            try {
                ...
                if ($usePagination) {
                    ...
                    $result = v2raysocks_traffic_getUserTrafficRankingsPaginated($sortBy, $timeRange, $startDate, $endDate, $startTimestamp, $endTimestamp, $cursor, $limit, $direction);
                    $result['status'] = 'success';
                    $result['pagination'] = true;
                    $result['sort_by'] = $sortBy;
                    $result['time_range'] = $timeRange;
        ...
        case 'get_usage_records':
            try {
                ...
                if ($usePagination) {
                    ...
                    $result = v2raysocks_traffic_getUsageRecordsPaginated($nodeId, $userId, $timeRange, $startDate, $endDate, $uuid, $startTimestamp, $endTimestamp, $cursor, $paginationLimit, $direction);
                    $result['status'] = 'success';
                    $result['pagination'] = true;
