            ...
            <form id="traffic-filter">
                <div class="filter-row">
                    <div class="filter-group">
                        ...
                        <input type="text" id="service-id" name="service_id" placeholder="' . v2raysocks_traffic_lang('enter_service_id') . '" style="width: 200px;">
                    </div>
                    <div class="filter-group">
                        <label for="time-range">' . v2raysocks_traffic_lang('time_range') . ':</label>
                        <select id="time-range" name="time_range" style="width: 200px;">
                    ...
                    <div class="filter-group" id="custom-dates" style="display: none;">
                        ...
                        <input type="date" id="start-date" name="start_date" style="width: 200px;">
                    </div>
                    ...
                    <div class="filter-group" id="custom-times" style="display: none;">
                        ...
                        <input type="time" id="start-time" name="start_time" step="1" style="width: 200px;">
                    </div>
                    <div class="filter-group" id="custom-times-end" style="display: none;">
                        ...
                        <input type="time" id="end-time" name="end_time" step="1" style="width: 200px;">
                    </div>
                    <div class="filter-group">
                        <label>&nbsp;</label>
