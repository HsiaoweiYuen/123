...
<body>
    ...
    <script>
        ...
        let userUsageRecordsPerPage = 500;
        ...
        function fetchUserRecentTrafficData() {
            ...
            const rankingsUrl = `addonmodules.php?module=v2raysocks_traffic&action=get_user_traffic_rankings&time_range=today&limit=all`;
        ...
        function loadUserUsageRecords() {
            const timeRange = document.getElementById("time-range").value;
            let urlParams = `addonmodules.php?module=v2raysocks_traffic&action=get_usage_records&user_id=${currentUserId}&time_range=${timeRange}`;
        ...
        function generateDefaultTimeLabels(timeRange = "today", points = 8) {
            ...
            switch (timeRange) {
                case "today":
                case "time_range":
                    // Generate hour labels for today and custom time ranges - only up to current hour
        ...
        function generateCompleteTimeSeriesForUserChart(timeRange) {
            ...
            switch (timeRange) {
                ...
                case "time_range":
                    // Generate hourly intervals for custom time range to match backend grouping
