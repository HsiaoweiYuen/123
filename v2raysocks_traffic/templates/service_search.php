    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === "success") {
                        ...
                        $("#service-traffic-data").html("<tr><td colspan=\\"11\\" class=\\"loading\\">' . v2raysocks_traffic_lang('no_usage_records_criteria') . '</td></tr>");
                    }
                },
                error: function(xhr, status, error) {
        ...
        function updateServicePaginatedTable() {
            ...
            if (allServiceData.length === 0) {
                html = "<tr><td colspan=\\"11\\" class=\\"no-data\\">' . v2raysocks_traffic_lang('no_usage_records_criteria') . '</td></tr>";
