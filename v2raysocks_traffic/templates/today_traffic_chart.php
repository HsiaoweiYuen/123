            ...
            switch (chartType) {
                case "combined":
                    ...
                    datasets = [
                        ...
                        getStandardDatasetConfig("total", "' . v2raysocks_traffic_lang('total_clean') . '", totalData, {fill: false})
                    ];
                    break;
                ...
                case "hourly":
                    ...
                    datasets = [
                        getStandardDatasetConfig("total", "' . v2raysocks_traffic_lang('total_clean') . '", totalOnlyData, {fill: true})
                    ];
                    break;
