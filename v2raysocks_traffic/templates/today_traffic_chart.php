            ...
            switch (chartType) {
                case "combined":
                    ...
                    datasets = [
                        ...
                        getStandardDatasetConfig("total", `' . v2raysocks_traffic_lang('total_traffic') . '`, totalData, {fill: false})
                    ];
                    break;
                ...
                case "hourly":
                    ...
                    datasets = [
                        getStandardDatasetConfig("total", `' . v2raysocks_traffic_lang('total_traffic') . '`, totalOnlyData, {fill: true})
                    ];
                    break;
