                    ...
                    <div style="background: #f8f9fa; padding: 15px; border: 1px solid #dee2e6; border-radius: 8px; margin-bottom: 20px;">
                        <div style="display: flex; gap: 15px; align-items: end; flex-wrap: wrap;">
                            <div style="flex: 0 0 180px; min-width: 150px;">
                                ...
                                <select id="node-search-type" style="width: 200px; padding: 5px 10px; border: 1px solid #ced4da; border-radius: 4px;">
                            ...
                            <div style="flex: 0 0 200px; min-width: 150px;">
                                ...
                                <input type="text" id="node-search-value" placeholder="' . v2raysocks_traffic_lang('search_value_placeholder') . '" style="width: 200px; padding: 5px 10px; border: 1px solid #ced4da; border-radius: 4px;">
                            </div>
