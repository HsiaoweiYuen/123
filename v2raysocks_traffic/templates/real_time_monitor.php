...
<head>
    ...
    <style>
        ...
        #rt-custom-dates input, #rt-custom-dates-end input, #rt-custom-times input, #rt-custom-times-end input { width: 100%; }
        ...
        <div class="filter-panel">
            ...
            <div style="background: #f8f9fa; padding: 15px; border: 1px solid #dee2e6; border-radius: 4px; margin-bottom: 15px;">
                <div style="display: flex; gap: 15px; align-items: end; flex-wrap: wrap;">
                    ...
                    <div class="filter-group" id="today-custom-times" style="display: none; flex: 1 1 auto;">
                    ...
                    <div class="filter-group" id="today-custom-times-end" style="display: none; flex: 1 1 auto;">
