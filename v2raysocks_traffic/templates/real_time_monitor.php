...
<head>
    ...
    <style>
        ...
        #rt-custom-dates, #rt-custom-dates-end, #rt-custom-times, #rt-custom-times-end { flex: 0 0 auto; width: auto; }
        ...
        <div class="filter-panel">
            ...
            <div style="background: #f8f9fa; padding: 15px; border: 1px solid #dee2e6; border-radius: 4px; margin-bottom: 15px;">
                <div style="display: flex; gap: 15px; align-items: end; flex-wrap: wrap;">
                    ...
                    <div class="filter-group" id="today-custom-times" style="display: none; flex: 0 0 auto; width: auto;">
                    ...
                    <div class="filter-group" id="today-custom-times-end" style="display: none; flex: 0 0 auto; width: auto;">
